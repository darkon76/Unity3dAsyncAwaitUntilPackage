...
namespace UnityAsyncAwaitUtil
{
    public class AsyncUtilTests : MonoBehaviour
    {
        ...
        public void OnGUI()
        {
            ...
            {
                RunMultipleThreadsTestAsync().Run();
            }

            if (_buttonHandler.Display("LoadScene"))
            {
        ...
        {
            // This should be logged when using Run
